...
const centrifugo_1 = __webpack_require__(66);
var Roles;
(function (Roles) {
...
class Api {
    ...
    sendMessage(message, channel, userId) {
        return axios_1.default.post(routes.sendMessage, { message, channel, userId })
            .catch(console.error);
    }
    getRooms() {
        return axios_1.default.get(routes.getRooms)
            .catch(console.error);
    }
    createRoom(userName, channel, userId) {
        return axios_1.default.post(routes.createRoom, { userName, channel, userId })
            .catch(console.error);
    }
    join(userName, channel, userId) {
        return axios_1.default.post(routes.joinRoom, { userName, channel, userId })
            .catch(console.error);
    }
    leave(channel, userId) {
        return axios_1.default.post(routes.leaveRoom, { channel, userId })
            .catch(console.error);
    }
    thanks(channel, userId) {
        return axios_1.default.post(routes.thanks, { channel, userId })
            .catch(console.error);
    }
}
const api = new Api();
...
const Centrifuge = __webpack_require__(82);
...
const app_1 = __webpack_require__(119);
...
const navigation_1 = __webpack_require__(171);
const footer_1 = __webpack_require__(172);
const sign_in_1 = __webpack_require__(173);
const select_role_1 = __webpack_require__(177);
const welcome_1 = __webpack_require__(180);
const chat_1 = __webpack_require__(181);
const rooms_1 = __webpack_require__(182);
__webpack_require__(185);
const user = user_1.userService.getUser();
navigation_1.navigation.start(user);
            ...
            React.createElement("div", { className: "inner cover" },
                React.createElement("div", null,
                    React.createElement("div", { className: "lead" },
                        ...
                        React.createElement(react_router_dom_1.Route, { path: "/chat/:room?", component: chat_1.Chat }),
...
class Chat extends React.Component {
    ...
    sendMessage() {
        api_1.api.sendMessage(this.state.message, this.channel, user.id);
    ...
    chat() {
        if (this.state.chatStarted) {
            return (React.createElement("div", { className: "margin-y-sm" },
                React.createElement("h3", null, " messages: "),
                React.createElement("div", { className: "messages margin-y-sm" }, this.state.history.map((item, i) => {
                    return (React.createElement("div", { className: "message", key: i },
                        item.author,
                        ": ",
                        item.message));
                })),
                React.createElement("input", { placeholder: 'message', type: 'text', onChange: this.handleMessageChange.bind(this), value: this.state.message }),
                React.createElement("button", { onClick: this.sendMessage.bind(this) }, "Send")));
        }
        return '';
    }
    toogleButton() {
        if (this.state.chatStarted) {
            return React.createElement("button", { className: 'btn btn-default', onClick: this.close.bind(this) }, "Say good buy and close connection");
        }
        else {
            return React.createElement("button", { className: 'btn btn-primary', onClick: this.start.bind(this) }, "Ask question to operator");
        }
    }
    start() {
        this.channel = `private:user${this.roomUserId || user.id}`;
        const centrifuge = centrifugo_1.centrifugoService.start();
        if (this.isOperator) {
            api_1.api.join(user.name, this.channel, user.id);
        }
        else {
            api_1.api.createRoom(user.name, this.channel, user.id);
        }
        ...
        this.subscription.history().then((response) => {
            if (response.data) {
                const history = response.data.reverse().map((item) => {
                    ...
                    return {
                        ...
                        isMine,
                        author: isMine ? "you" : user_1.userService.hasOppositeRoleLabel(),
                        inProcess: false,
    ...
    leave(response) {
        if (response.data && response.data.user != user.id && this.operatorConnected) {
            api_1.api.leave(this.channel, response.data.user);
            this.operatorConnected = false;
        }
    }
    unsubscribe(response) {
        api_1.api.thanks(this.channel, user.id);
    }
    receiveMessage(response) {
        ...
        const author = isMine ? "you" : user_1.userService.hasOppositeRoleLabel();
...
class Rooms extends React.Component {
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement("h3", null, "Rooms"),
            this.state.rooms.map((room, i) => {
                return (React.createElement("div", { className: "room margin-y-sm", key: i },
    ...
    joinBtn(room) {
        if (!room.operator) {
            return (React.createElement(react_router_dom_1.Route, { render: ({ history }) => (React.createElement("button", { className: "btn btn-default join-btn margin-x-sm", onClick: this.join.bind(this, room, history) }, "Join")) }));
        }
        return React.createElement("div", { className: "margin-x-sm" },
            "In dialog with operator ",
            room.operator);
    }
    join(room, history) {
    ...
    getRooms() {
        api_1.api.getRooms().then((response) => {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js?url=false!../../../../node_modules/less-loader/dist/cjs.js!./rooms.less", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js?url=false!../../../../node_modules/less-loader/dist/cjs.js!./rooms.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".join-btn {\n  display: inline-block;\n}\n.room {\n  width: 500px;\n}\n", ""]);
